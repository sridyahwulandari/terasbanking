...
class MenuNavigasiSearch extends MenuNavigasi
{
    ...
    public function search($params)
    {
        ...
        ->where(["menu_navigasi.id_parent"=>0]);
        ...
        $query->andFilterWhere(['like', 'menu_navigasi.nama_menu', $this->nama_menu])
        ->andFilterWhere(['like', 'menu_navigasi.url', $this->url])
        ->andFilterWhere(['like', 'menu_navigasi.nama_menu', $this->parent])
        ->andFilterWhere(['like', 'menu_navigasi.icon', $this->icon]);
